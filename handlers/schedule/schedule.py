...
from handlers.menu.inline_menu import InlineMenu
...
from .inline_first_menu import FirstMenuSchedule
from .inline_second_menu import SecondMenuSchedule
from .inline_calendar import Calendar
